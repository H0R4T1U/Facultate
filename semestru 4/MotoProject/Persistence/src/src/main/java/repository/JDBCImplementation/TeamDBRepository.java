...
import Persistence.src.main.java.repository.TeamRepository;
...
public class TeamDBRepository implements TeamRepository {
    ...
    public Optional<Team> findTeamByName(String name) {
        logger.traceEntry("finding team by name {}", name);
        Connection con = dbUtils.getConnection();
        try (var preStmt = con.prepareStatement("select * from Team where Name = ?")) {
